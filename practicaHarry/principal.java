...
public class principal {
    public static void main(String[] args) {
        ...
        constructor Hermione = new constructor("Gryffindor","Femenino","Hermione Jean Granger ","La profesora McGonagall le dice que reprobó todos sus exámenes","nutria");
